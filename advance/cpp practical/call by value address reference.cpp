//20.Write a C++ program to demonstrate parameter passing mechanism using
...
int main()
{
    ...
    cout << "Value before Swapping x:" << x << " y:" << y << endl;
    swapByAdr( x , y  );  /*Swapping reflect but reference does not take space in memory*/
    cout << "Value After  Swapping x:" << x << " y:" << y << endl << endl; 
    ...
    cout << "Value before Swapping x:" << x << " y:" << y << endl;
    swapByRef( &x , &y  ); /*Swapping reflect but pointer takes space in memory*/
    cout << "Value After  Swapping x:" << x << " y:" << y << endl << endl;  
