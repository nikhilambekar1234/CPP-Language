/*/*9.We want to store the information of different vehicles. Create a class named Vehicle with two data member
...
*Bike with data membersto store the number of cylinders, number of gears, cooling type(air, liquid or oil), 
...
int main()
{
	Audi carAudi1(10000,36000,29000,10,3,"diesel");
	Audi carAudi2(20000,26000,19000,5,1,"petrol");
	
	Ford carFord1(10000,36000,29000,10,3,"diesel");
	Ford carFord2(20000,26000,19000,5,1,"petrol");
